...
export default function MarketingFooter() {
  ...
  const footerLinks = {
    ...
    company: [
      ...
      { label: 'Blog', href: '#' },
      { label: 'Careers', href: '#' },
      { label: 'Contact', href: 'mailto:hello@rechub.app' }
    ],
    legal: [
    ...
    support: [
      ...
      { label: 'Email Support', href: 'mailto:support@rechub.app' }
    ]
  }
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 pb-12 border-b border-slate-800">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-slate-400 mb-6 max-w-sm">
              Modern website builder and management platform built specifically for recreation departments.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-400">
            © {currentYear} RecHub. All rights reserved.
          </p>
